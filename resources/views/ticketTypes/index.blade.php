...
<body>
  <nav class="navbar navbar-expand-lg bg-body-tertiary bg-dark border-bottom border-body" data-bs-theme="dark">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="{{url('/ticketTypes')}}" >Tipos de ticket</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="container mt-3">
        <h1>Lista de Tipos de Tickets</h1>
        <table class="table">
            <thead>
                <th>ID</th>
                <th>Tipo</th>
        ...
        <a href="{{ route('ticketTypes.create')}}" class="btn btn-dark">Crear tipos de ticket</a>
    </div>
